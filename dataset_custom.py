...
class CaptioningDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # Reference Caption
        text_r, input_mask_r, segment_ids_r, input_idf = self.tokenize(self.gt_caps[index].lower())
        ...
        features, spatials, image_mask, co_attention_mask = self.img_preprocess(self.imgs[index])
